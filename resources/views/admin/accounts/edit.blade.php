            ...
            <form action="{{ route('accounts.update',['account'=>$account->id]) }}" method="POST">
                ...
                <div class=" mb-3">
                    ...
                    <select name="usertype" id="usertype" class="form-select" required>
                        <option value="Admin" {{ old('usertype',$account->type) == "Admin" ? 'selected' : ''}}>
                            مدير
                        </option>
                        <option value="Delivery"{{ old('usertype',$account->type) == "Delivery" ? 'selected' : ''}}>توصيل</option>
                        <option value="Printer"{{ old('usertype',$account->type) == "Printer" ? 'selected' : ''}}>طباعة</option>
                    </select>
